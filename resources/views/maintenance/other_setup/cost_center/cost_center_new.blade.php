<div class="modal fade" id="cost_center_modal" role="dialog">
            ...
            <div class="modal-header">
                ...
                <div class="modal-title mdl-title text-center">
                    <strong class="font-title">
                        <i class="fa fa-plus-circle" aria-hidden="true"></i> New Cost Center
                    </strong>
                </div>
            </div>
            <div class="modal-body">
                <div class="form-group-sm">
                    <div class = "container-fluid text-left mt-20">
                        ...
                        <form v-on:submit.prevent="cost_center_new_submit($event)">
                            {{ csrf_field() }}
                            <div class = "col-md-12">

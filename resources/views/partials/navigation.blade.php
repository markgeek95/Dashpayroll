<div class="navbar-header">
    ...
    <a class="navbar-brand" href="dashboard/">
        <figure>
            <img src="{{ asset('public/images/logo.png') }}" width="30px" alt="DashPayroll Logo">
            DashPayroll
        </figure>
    </a>
</div>
...
<ul class="nav navbar navbar-right icons hidden-xs">
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown">
            <img src="{{ asset('public/images/adminicon.png') }}" alt="Admin" style="zoom:80%" /> <span class="caret"></span>
        </a>
        <ul class="dropdown-menu">
...
<ul class="nav navbar navbar-right icons visible-xs">
    ...
    <li class="dropdown">
        <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown">
            <img src="{{ asset('public/images/adminicon.png') }}" alt="Admin" style="zoom:80%" />

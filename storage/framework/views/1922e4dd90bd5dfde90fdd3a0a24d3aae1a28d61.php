...
<?php $__env->startSection('content'); ?>
    ...
    <div id="page-wrapper">
      ...
      <?php echo $__env->make('maintenance.government_tables.sss_modal_add', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <?php echo $__env->make('maintenance.government_tables.sss_modal_edit', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

        <div class="tab">
            <?php echo $__env->make('maintenance.government_tables.tabs', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
                  ...
                  <table class="table table-bordered" id="dadasTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo e($data->ec); ?></td>
                        <td class="text-center">
                          <button type="submit" class="btn btn-primary btn-sm"
                          v-on:click="sss_maintenance_edit($event, <?php echo e($data->sss_id); ?>)">
                            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                          </button>
                          <button type="submit" class="btn btn-danger btn-sm"
                          v-on:click="sss_maintenance_delete(<?php echo e($data->sss_id); ?>)">

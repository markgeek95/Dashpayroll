<!--  Modal -->
<div class="modal fade" id="add_philheatlh_modal" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header addColor">
        <div class="modal-title text-center">
          <strong class="font-title"> 
            <i class="fa fa-line-chart" aria-hidden="true"></i> Add PhilHealth 
          </strong>
      ...
      <div class="modal-body">
        <div class="container-fluid ">
          ...
          <form v-on:submit.prevent="philhealth_maintenance_submit($event)">

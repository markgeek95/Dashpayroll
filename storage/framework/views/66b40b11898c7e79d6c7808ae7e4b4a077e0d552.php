...
<?php $__env->startSection('content'); ?>
    ...
    <div id="page-wrapper">
      ...
      <?php echo $__env->make('maintenance.government_tables.philhealth_modal', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      <?php echo $__env->make('maintenance.government_tables.philhealth_modal_edit', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                              ...
                              <tbody>
                                <?php if(!$datas->isEmpty()): ?>
                                  ...
                                  <tr>
                                        ...
                                        <td class="text-right"><?php echo e(number_format($data->amount, 2)); ?></td>
                                        <td class="text-right"><?php echo e(number_format($data->rate, 2)); ?></td>
                                        <td>

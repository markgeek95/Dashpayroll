<!--  Modal add-->
<div class="modal fade" id="sss_edit_modal" role="dialog">
      ...
      <div class="modal-header addColor">
        <div class="modal-title text-center">
          <strong class="font-title"> 
            <i class="fa fa-line-chart" aria-hidden="true"></i> Edit SSS 
          </strong>
      ...
      <div class="modal-body">
        <div class="container-fluid ">
          <div class="row">
            ...
            <form v-on:submit.prevent="sss_edit_submit_form($event)">
